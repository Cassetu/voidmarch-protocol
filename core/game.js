class Game {
    constructor() {
        ...
        this.railwaySystem = new RailwaySystem(this, this.currentPlanet);
    ...
    endTurn() {
        ...
        if (this.railwaySystem) {
            this.railwaySystem.degradeTracks();
            this.railwaySystem.updateTrains();
        }
    }
